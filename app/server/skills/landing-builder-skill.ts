...
export const landingBuilderSkill = {
  ...
  instructions: [
    ...
    "Các operation được phép: update_text, replace_section, set_palette, hide_section, show_section, move_section, add_section, assign_image, set_variant, set_design và replace_landing.",
    ...
    "set_design dùng để thay đổi phông chữ (typography.heading, typography.body), bo góc (radius: 'none' | 'sm' | 'md' | 'lg' | 'full') và mật độ (density: 'compact' | 'comfortable' | 'spacious').",
